from .modeling_bert_of_theseus import MobileBertEncoder


class ConstantReplacementScheduler:
    def __init__(self, bert_encoder: MobileBertEncoder, replacing_rate, replacing_steps=None):
...
class LinearReplacementScheduler:
    def __init__(self, bert_encoder: MobileBertEncoder, base_replacing_rate, k):
        self.bert_encoder = bert_encoder
